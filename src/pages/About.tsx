    ...
    <div>
      ...
      <div className='mt-8 flex flex-col gap-5 dark:text-grays text-zinc-900 transition'>
        <p>
          ...
          Санкт-петербурга, работаю в сфере веб-разработки. <br />
          Мне нравится превращать сложные задачи в простые, красивые и полезные
          проекты.
        </p>
        <p>
          Я владею современным стеком технологий, включая HTML5, CSS3,
          JavaScript (ES6+), React, Redux-toolkit, а также знаком с
          инструментами сборки проектов как Webpack, Vite и Gulp.
        </p>
        <p>
          Ознакомьтесь с моими работами в разделе Портфолио и свяжитесь со мной,
          если вы заинтересованы в сотрудничестве или у вас есть вопросы.
          <br /> С нетерпением жду новых интересных задач и проектов!
        </p>
      </div>
      <div className='mt-14  '>
        <div className='text-3xl transition font-bold text-zinc-800 dark:text-white'>
          Чем я занимаюсь
        </div>
          ...
          <div className='border-[#212425] border-solid border-[1px] rounded-xl p-5 '>
            <div className='flex gap-4'>
              ...
              <div className='transition'>
                <div className='text-zinc-900 dark:text-white font-normal text-xl'>
                  Разработка Single Page Applications (SPA)
                </div>
                <p className='text-zinc-700 dark:text-grays mt-2'>
